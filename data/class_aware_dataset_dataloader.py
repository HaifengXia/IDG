...
class ClassAwareDataLoader(object):
    ...
    def __init__(self, source_batch_size, 
                source_dataset_root_1="", source_dataset_root_2="", source_dataset_root_3="",
        ...
        # dataset parameters
        self.source_dataset_root_1 = source_dataset_root_1
        self.source_dataset_root_2 = source_dataset_root_2
        self.source_dataset_root_3 = source_dataset_root_3
    ...
    def construct(self):
        self.dataset.initialize(source_root_1=self.source_dataset_root_1, 
                  source_root_2 = self.source_dataset_root_2,
                  source_root_3 = self.source_dataset_root_3,
    ...
    def __len__(self):
        ...
        for c in self.class_set:
            c_len = max([len(self.dataset.data_paths[d][cid]) // \
                  self.dataset.batch_sizes[d][cid] for d in ['source_1', 'source_2', 'source_3']])
            dataset_len += c_len
            cid += 1
